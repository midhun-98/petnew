    ...
    if($pic!="")
 		 {
  			  ...
  			  $file_ext=$filearray["extension"];
   			   ...
   			   move_uploaded_file($_FILES['f1']['tmp_name'],"api/images/gallery/".$filenew);

		  }
    
    mysqli_query($conn,"INSERT INTO product_tb(product_name,price,category,image) VALUES ('$name','$price','$category','$filenew')");
