...
$filenew = "";
	...
	$query1=mysqli_query($conn,"INSERT INTO register_tb(login_id,name,address,mobile,email,adhar,license,username,password)VALUES('$id','$name','$address','$mobile','$email','$adhar','$filenew','$user','$pass')");
