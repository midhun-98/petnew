...
session_start();
include 'conn.php';
$query=mysqli_query($conn,"SELECT * FROM request_tb join register_tb on request_tb.login_id=register_tb.login_id where status='0'"); 
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 p-l-0 title-margin-left">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Dashboard/Request</a></li>
